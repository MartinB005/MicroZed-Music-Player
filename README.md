...
Current implementation uses 3 GPIO pins and 2 shift registers (see [DAC.cpp](peripherals/DAC.cpp) and [mz_apo_regs.h](core/mz_apo_regs.h) where is adresses of mapped pins).
